...
; REQUIRES: asserts
; RUN: opt -S -passes=attributor -attributor-enable-all-abstract-attributes --attributor-seed-allow-list asd < %s | FileCheck %s --check-prefixes=CHECK_DISABLED
; RUN: opt -S -passes=attributor -attributor-enable-all-abstract-attributes --attributor-seed-allow-list AAValueSimplify < %s | FileCheck %s --check-prefixes=CHECK_ENABLED
; RUN: opt -S -passes=attributor -attributor-enable-all-abstract-attributes --attributor-function-seed-allow-list asd < %s | FileCheck %s --check-prefixes=CHECK_DISABLED_FUNCTION
; RUN: opt -S -passes=attributor -attributor-enable-all-abstract-attributes --attributor-function-seed-allow-list range_use1 < %s | FileCheck %s --check-prefixes=CHECK_ENABLED_FUNCTION
