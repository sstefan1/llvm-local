...
; IS__TUNIT____-LABEL: define {{[^@]+}}@complicated_args_preallocated()
; IS__TUNIT____-NEXT:    [[C:%.*]] = call token @llvm.call.preallocated.setup(i32 1)
; IS__TUNIT____-NEXT:    [[CALL:%.*]] = call i32* @test_preallocated(i32* noalias nocapture nofree writeonly preallocated(i32) align 536870912 null) #1 [ "preallocated"(token [[C]]) ]
; IS__TUNIT____-NEXT:    ret i32* [[CALL]]
;
