...
; RUN: opt -attributor -enable-new-pm=0 -attributor-enable-all-abstract-attributes -S %s | FileCheck %s
; RUN: opt -passes=attributor -attributor-enable-all-abstract-attributes -S %s | FileCheck %s
