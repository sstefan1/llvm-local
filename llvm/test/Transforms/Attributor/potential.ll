...
; RUN: opt -enable-new-pm=0 -attributor-cgscc -attributor-manifest-internal -attributor-enable-all-abstract-attributes -attributor-annotate-decl-cs -S < %s | FileCheck %s --check-prefixes=CHECK,NOT_TUNIT_NPM,NOT_TUNIT_OPM,NOT_CGSCC_NPM,IS__CGSCC____,IS________OPM,IS__CGSCC_OPM
