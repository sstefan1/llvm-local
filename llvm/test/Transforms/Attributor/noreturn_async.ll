...
; RUN: opt -attributor  -attributor-max-iterations-verify -attributor-enable-all-abstract-attributes -attributor-annotate-decl-cs -attributor-max-iterations=1 -S < %s | FileCheck %s
;
