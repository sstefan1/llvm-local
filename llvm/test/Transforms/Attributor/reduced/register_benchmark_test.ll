...
; RUN: opt -attributor -enable-new-pm=0  -attributor-max-iterations-verify -attributor-enable-all-abstract-attributes -attributor-annotate-decl-cs -attributor-max-iterations=1 -S < %s
; RUN: opt -attributor-cgscc -enable-new-pm=0  -attributor-enable-all-abstract-attributes -attributor-annotate-decl-cs -attributor-max-iterations=1 -S < %s
; RUN: opt -passes=attributor  -attributor-max-iterations-verify -attributor-enable-all-abstract-attributes -attributor-annotate-decl-cs -attributor-max-iterations=1 -S < %s
; RUN: opt -passes='attributor-cgscc'  -attributor-annotate-decl-cs -attributor-enable-all-abstract-attributes -attributor-max-iterations=1 -S < %s
