...
; NOT_CGSCC_NPM-NEXT:    call void @llvm.lifetime.start.p0i8(i64 144, i8* nocapture nofree nonnull align 8 dereferenceable(240) [[TMP0]])
...
; NOT_CGSCC_NPM-NEXT:    call void @llvm.lifetime.end.p0i8(i64 144, i8* nocapture nofree nonnull align 8 dereferenceable(240) [[TMP0]])
...
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.start.p0i8(i64 144, i8* nocapture nofree nonnull align 8 dereferenceable(240) [[TMP0]])
...
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.end.p0i8(i64 144, i8* nocapture nofree nonnull align 8 dereferenceable(240) [[TMP0]])
