; RUN: opt -passes=attributor-cgscc  -attributor-annotate-decl-cs -attributor-enable-all-abstract-attributes -attributor-allow-shallow-wrappers -S < %s | FileCheck %s --check-prefix=CHECK
