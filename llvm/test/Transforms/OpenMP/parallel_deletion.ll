...
; RUN: opt -S -attributor -attributor-enable-all-abstract-attributes -openmpopt  < %s | FileCheck %s
; RUN: opt -S -passes='attributor,cgscc(openmpopt)' -attributor-enable-all-abstract-attributes  < %s | FileCheck %s
;
